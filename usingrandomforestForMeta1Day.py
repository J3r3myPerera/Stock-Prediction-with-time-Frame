# -*- coding: utf-8 -*-
"""UsingRandomForest for Meta.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EDGTSce0VXGZ7KEj7FjGuVeZ2cKkVcCk
"""
...
df = yf.download('META', start ='2012-05-18')
df
...
def backtest(data, model, predictors, start=630, step=63):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
horizons = [1,2,5,21,63] #Mean close price for a number of days, starting from 2 days behind upuntil one year
...
model = RandomForestClassifier(n_estimators=250, min_samples_split=160, random_state=1)
...
df.to_csv('Meta dataframe for 1day.csv')