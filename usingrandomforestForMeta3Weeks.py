# -*- coding: utf-8 -*-
"""UsingRandomForest for Meta 3 weeks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gRyvNlYgr3YprtzgFsDsEheBrmQRqmc6
"""
...
df = yf.download('META', start ='2012-05-18', interval = '1wk')
df
...
def backtest(data, model, predictors, start=500, step=50):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
horizons = [1,6,50] #Mean close price for a number of days, starting from 2 days behind upuntil one year
...
df.to_csv('Meta dataFrame for 3 weeks.csv', index = True)
