# -*- coding: utf-8 -*-
"""UsingRandomForest for Apple 2 weeks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1n9XmsL1LFPZ-NsQhChgRnCdBLc7sEvsI
"""
...
horizons = [2,6,50] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
df.to_csv('Apple Dataframe for 2 weeks.csv', index=True)
