# -*- coding: utf-8 -*-
"""UsingRandomForest for Tesla 2weeks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10rUVEgDAPhqALypSLaX__YslQ_TlzgMR
"""
...
def backtest(data, model, predictors, start=520, step=52):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
horizons = [1,4,50,100] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
df.to_csv('TeslaDataFrameFor1week.csv')
