# -*- coding: utf-8 -*-
"""UsingRandomForest for google 1 month.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1z_F3LLTMfkNzCE8A4tIleCdS_bjAmd1K
"""
...
df = yf.download('GOOG', start ='2004-08-19', interval = '1mo')
df
...
df.to_csv('Gogole dataset for 1month.csv', index = True)
