# -*- coding: utf-8 -*-
"""UsingRandomForestForApple1Week.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1971W4wQZHa3qUGiB7i9xyr0i12c2sUHf
"""
...
df["Week Before"] = df["Close"].shift(-5) 
df

#Removing the records which dont have data
# df = df.dropna()
# df
...
df["Target"] = (df["Week Before"] > df["Close"]).astype(int)
df

#Calculating the testing and the training lengths
length = len(df.index)
...
horizons = [5,21,63,250] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
