# -*- coding: utf-8 -*-
"""UsingRandomForest for Tesla.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wvrn-jYBejXStWAcE7JHRMl_CvF1j4WI
"""
...
df = yf.download('TSLA', start ='2010-06-29')
df
...
#Changing hte estimators and the samples to check the precision score
 model = RandomForestClassifier(n_estimators=450, min_samples_split=100, random_state=1)
 train = df.iloc[:-958] 
 test = df.iloc[-958:]
...
horizons = [1,5,21,63,250] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
model = RandomForestClassifier(n_estimators=375, min_samples_split=150, random_state=1)
...
df.to_csv('Tesla dataset for 1day.csv')