# -*- coding: utf-8 -*-
"""UsingRandomForest for Tesla 1 month.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XLvqp3COVd1jzvMHcbjE06DbNLNQityF
"""
...
df = yf.download('TSLA', start ='2010-06-29', interval = '1mo')
df
...
horizons = [1,2,4,12,24] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
model = RandomForestClassifier(n_estimators=350, min_samples_split=60, random_state=1)
...
df.to_csv('Tesla dataset for 1 month.csv', index = True)
