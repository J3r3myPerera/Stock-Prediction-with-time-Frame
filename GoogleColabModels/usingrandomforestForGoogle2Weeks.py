# -*- coding: utf-8 -*-
"""UsingRandomForest for google 2 weeks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1q4H1n9dtNFQ9bI_qTYx6DKu3LOw52XHv
"""
...
df = yf.download('GOOG', start ='2004-08-19', interval = '1wk')
df
...
def backtest(data, model, predictors, start=50, step=500):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
horizons = [1,2,13,50,] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
df.to_csv('GoogleDataFrame2weeks')
