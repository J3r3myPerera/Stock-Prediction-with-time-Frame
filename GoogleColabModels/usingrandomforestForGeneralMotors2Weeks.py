# -*- coding: utf-8 -*-
"""UsingRandomForest for General motors 2 weeks.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kjCFWE1tizPNJXUQC-efF4GxBiQH5hB1
"""
...
def backtest(data, model, predictors, start=250, step=25):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
horizons = [2,6,13] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
df.to_csv('GM dataset for2weeks.csv', index =True)
