# -*- coding: utf-8 -*-
"""UsingRandomForest for Apple.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14NDJlWxefj68MXrrlzcTMMEgH4mUfSCq
"""
...
horizons = [2,5,21,48,63,250] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
model = RandomForestClassifier(n_estimators=350, min_samples_split=180, random_state=1)
...
df.to_csv('apple dataframe for 1day.csv')
