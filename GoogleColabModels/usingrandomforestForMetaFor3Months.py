# -*- coding: utf-8 -*-
"""UsingRandomForest for Meta for 3 months.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zJYCUzh_b2HWBlcG2LTDfgIGdOAJIGNE
"""
...
#Building the model with the random forest
 ...
 model = RandomForestClassifier(n_estimators=350, min_samples_split=10, random_state=1)
 train = df.iloc[:38] 
 test = df.iloc[-38:]
...
def backtest(data, model, predictors, start=40, step=4):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
df.to_csv('meta DataFrame for 3 months.csv')
