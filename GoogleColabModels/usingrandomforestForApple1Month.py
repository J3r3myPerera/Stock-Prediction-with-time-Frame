# -*- coding: utf-8 -*-
"""UsingRandomForest for Apple 1 month.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1iC-3Pd4K5EfLYeYOQdmBd9h80Xw7cU9p
"""
...
df = yf.download('AAPL', start ='1980-12-12', interval = '1mo')
df
...
def backtest(data, model, predictors, start=120, step=12):#training the model for a year and then moving forward from year to year
  all_predictions =[]
...
horizons = [2,3,4,6,12] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
model = RandomForestClassifier(n_estimators=200, min_samples_split=60, random_state=1)
...
df.to_csv('Apple datset for 1 month.csv')

import pandas as pd
df2 = pd.read_csv('Apple datset for 1 month.csv')
df2
