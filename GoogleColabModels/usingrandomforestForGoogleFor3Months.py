# -*- coding: utf-8 -*-
"""UsingRandomForest for google for 3 months.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IDALSZktLaYutcXGwlNlClgMWQBengQq
"""
...
horizons = [2,4,5,6] #Mean close price for a number of days, starting from 2 days behind upuntil one year
new_predictors = []
...
df.to_csv('google dataset for 3 months.csv')
